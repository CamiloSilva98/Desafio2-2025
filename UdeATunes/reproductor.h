 ...
 * - siguiente, anterior, repetir, detener (según tipo de usuario)
 */
class Reproductor {
private:
...
public:
    ...
    void anterior();            // Retroceder a la canción anterior
    void toggleRepetir();       // Activar/desactivar modo repetir
